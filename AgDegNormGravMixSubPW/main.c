...
int main (int argc, const char * argv[]) {
    ...
    double lps=0, alphau=0, atrans=0, rload=0, Cexp=0, nexp=0, fracsandl=0, rB=0;
    double Dsgsi=0, Dx50si=0, Dx90si=0, dx=0, time=0, Sinu=0, subrate=0, lamda=0;
    double ExnerFactor=0, Cf=0;
    ...
    double dsgs[101], fracsand[101], qbT[101], tausg[101], taus50[101], H[101], Laold[101];
        ...
        check = Initialize(GSD, &qw, &qbTf, &I, &etad, &S, &L, &dt, &M, &prints, &iterates,
                    ...
                    &Sinu, &subrate, &lamda, &rB, &ExnerFactor, &Cf, &formulation);
        if (check == 1)
            return 1;
